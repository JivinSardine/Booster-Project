...
var g_house, pan1,pan2,pan3,pan4,fan,fan2,fan3,fan4;
...
function setup() 
{
  ...
  pan2 = createSprite(width-110,height-50,80,80);
  pan2.addImage(s_pan);
  pan2.scale = 0.75;

  pan3 = createSprite(80,height-200,80,80);
  pan3.addImage(s_pan);
  pan3.scale = 0.75;

  pan4 = createSprite(width-110,height-200,80,80);
  pan4.addImage(s_pan);
  pan4.scale = 0.75;
  ...
  fan3 = createSprite(280,400,20,20);
  fan3.addImage(fan_img);
  fan3.scale = 0.3;
  fan3.addAnimation('run',fan_anim);
  
  fan4 = createSprite(450,400,20,20);
  fan4.addImage(fan_img);
  fan4.scale = 0.3;
  fan4.addAnimation('run',fan_anim);
  textSize(15);
